        ...
        <View className="gap-3">
          {selectedCharacters.map((c) => {
            ...
            return (
              <View
                key={c.id}
                className="rounded-xl border border-zinc-800 bg-zinc-900/75 p-3"
              >
                ...
                <View className="mt-3">
                  ...
                  <TextInput
                    ...
                    maxLength={30}
                    className="mt-1 h-10 rounded-lg border border-zinc-700 bg-zinc-800 px-3 text-sm text-white"
                  />
                </View>
              </View>
            );
